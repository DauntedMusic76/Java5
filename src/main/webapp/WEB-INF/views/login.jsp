...
<body>
    <section class="py-3 py-md-5 py-xl-8">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="mb-5 text-center">
                        ...
                        <p class="m-0">Don't have an account? <a href="register.htm">Sign up</a></p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="row gy-5 justify-content-center">
                        ...
                        <div class="col-12 col-lg-2 d-flex align-items-center justify-content-center flex-column">
                            <div class="divider w-100 d-lg-none"></div>
                            <div>or</div>
                            <div class="divider w-100 d-lg-none"></div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="d-flex flex-column gap-3">
                                <a href="https://www.google.com/" class="btn btn-outline-dark rounded-0 d-flex align-items-center social-btn">
                                    ...
                                    <span class="ms-2 flex-grow-1">Continue with Google</span>
                                </a>
                                <a href="#!" class="btn btn-outline-dark rounded-0 d-flex align-items-center social-btn">
                                    ...
                                    <span class="ms-2 flex-grow-1">Continue with Apple</span>
                                </a>
                                <a href="#!" class="btn btn-outline-dark rounded-0 d-flex align-items-center social-btn">
                                    ...
                                    <span class="ms-2 flex-grow-1">Continue with Facebook</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="message ${successMessage != null ? 'success' : errorMessage != null ? 'error' : ''}">
